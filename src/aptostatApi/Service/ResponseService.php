...
class ResponseService
{
    ...
    public static function errorResponse($e)
    {
        ...
        $formattedErrorMsg['error']['statusDesc'] = self::getStatusDesc($e->getCode());
    ...
    {
        $formattedSuccessMsg = array();

        $formattedSuccessMsg['message'] = $message;

        return $formattedSuccessMsg;
    }
     ...
     * @return string
     */
    private function getStatusDesc($statusCode)
    {
        $status = array(
            100 => 'Continue',
