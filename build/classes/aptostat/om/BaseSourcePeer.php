...
abstract class BaseSourcePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idsource', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idsource', 'name', ),
        BasePeer::TYPE_COLNAME => array (SourcePeer::IDSOURCE, SourcePeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDSOURCE', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('IdSource', 'Name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idsource' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idsource' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (SourcePeer::IDSOURCE => 0, SourcePeer::NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDSOURCE' => 0, 'NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('IdSource' => 0, 'Name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SourcePeer::IDSOURCE);
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SourcePeer::IDSOURCE);
            $value = $criteria->remove(SourcePeer::IDSOURCE);
            if ($value) {
                $selectCriteria->add(SourcePeer::IDSOURCE, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SourcePeer::IDSOURCE, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(SourcePeer::DATABASE_NAME);
        $criteria->add(SourcePeer::IDSOURCE, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(SourcePeer::DATABASE_NAME);
            $criteria->add(SourcePeer::IDSOURCE, $pks, Criteria::IN);
