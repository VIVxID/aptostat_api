...
abstract class BaseSource extends BaseObject implements Persistent
{
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdsource($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SourcePeer::IDSOURCE)) $criteria->add(SourcePeer::IDSOURCE, $this->idsource);
    ...
    {
        $criteria = new Criteria(SourcePeer::DATABASE_NAME);
        $criteria->add(SourcePeer::IDSOURCE, $this->idsource);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdsource(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     * @return PropelObjectCollection|Report[] List of Report objects
     */
    public function getReportsJoinService($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ReportQuery::create(null, $criteria);
