 ...
 * @method MessageQuery orderByIdflag($order = Criteria::ASC) Order by the IdFlag column
 ...
 * @method MessageQuery orderByVisible($order = Criteria::ASC) Order by the Visible column
 *
 ...
 * @method MessageQuery groupByIdflag() Group by the IdFlag column
 ...
 * @method MessageQuery groupByVisible() Group by the Visible column
 *
 ...
 *
 * @method MessageQuery leftJoinFlag($relationAlias = null) Adds a LEFT JOIN clause to the query using the Flag relation
 * @method MessageQuery rightJoinFlag($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Flag relation
 * @method MessageQuery innerJoinFlag($relationAlias = null) Adds a INNER JOIN clause to the query using the Flag relation
 *
 ...
 * @method Message findOneByIdflag(int $IdFlag) Return the first Message filtered by the IdFlag column
 ...
 * @method Message findOneByVisible(boolean $Visible) Return the first Message filtered by the Visible column
 *
 ...
 * @method array findByIdflag(int $IdFlag) Return Message objects filtered by the IdFlag column
 ...
 * @method array findByVisible(boolean $Visible) Return Message objects filtered by the Visible column
 *
...
abstract class BaseMessageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `IdMessage`, `IdIncident`, `IdFlag`, `Timestamp`, `Text`, `Author`, `Visible` FROM `Message` WHERE `IdMessage` = :p0';
        try {
    ...
    public function filterByIdflag($idflag = null, $comparison = null)
    {
        if (is_array($idflag)) {
            $useMinMax = false;
            if (isset($idflag['min'])) {
                $this->addUsingAlias(MessagePeer::IDFLAG, $idflag['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idflag['max'])) {
                $this->addUsingAlias(MessagePeer::IDFLAG, $idflag['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(MessagePeer::IDFLAG, $idflag, $comparison);
    }
    ...
    public function filterByVisible($visible = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(MessagePeer::VISIBLE, $visible, $comparison);
    }
    ...
    public function filterByFlag($flag, $comparison = null)
    {
        if ($flag instanceof Flag) {
            return $this
                ->addUsingAlias(MessagePeer::IDFLAG, $flag->getIdflag(), $comparison);
            ...
            return $this
                ->addUsingAlias(MessagePeer::IDFLAG, $flag->toKeyValue('PrimaryKey', 'Idflag'), $comparison);
        } else {
