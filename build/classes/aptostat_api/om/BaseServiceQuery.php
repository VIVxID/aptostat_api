 ...
 *
 * @method ServiceQuery leftJoinReport($relationAlias = null) Adds a LEFT JOIN clause to the query using the Report relation
 * @method ServiceQuery rightJoinReport($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Report relation
 * @method ServiceQuery innerJoinReport($relationAlias = null) Adds a INNER JOIN clause to the query using the Report relation
 *
...
abstract class BaseServiceQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'Aptostat', $modelName = 'Service', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `IdService`, `Name` FROM `Service` WHERE `IdService` = :p0';
        try {
    ...
    public function filterByReport($report, $comparison = null)
    {
        if ($report instanceof Report) {
            return $this
                ->addUsingAlias(ServicePeer::IDSERVICE, $report->getIdservice(), $comparison);
