...
/**
 * Base class that represents a row from the 'ReportStatus' table.
 *
 *
 *
 * @package    propel.generator.aptostat_api.om
 */
abstract class BaseReportStatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ReportStatusPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ReportStatusPeer
     */
    ...
    public function setIdreport($v)
    {
        ...
        if ($this->idreport !== $v) {
            $this->idreport = $v;
            $this->modifiedColumns[] = ReportStatusPeer::IDREPORT;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ReportStatusPeer::TIMESTAMP;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ReportStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ReportStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ReportStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ReportStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ReportStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ReportStatusPeer::IDREPORT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `ReportStatus` (%s) VALUES (%s)',
    ...
    {
        $pos = ReportStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ReportStatus'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ReportStatus'][serialize($this->getPrimaryKey())] = true;
        $keys = ReportStatusPeer::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(ReportStatusPeer::DATABASE_NAME);
        $criteria->add(ReportStatusPeer::IDREPORT, $this->idreport);
        $criteria->add(ReportStatusPeer::TIMESTAMP, $this->timestamp);
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdreport();
        $pks[1] = $this->getTimestamp();
    ...
    {
        $this->setIdreport($keys[0]);
        $this->setTimestamp($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdreport()) && (null === $this->getTimestamp());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ReportStatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ReportStatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ReportStatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ReportStatusPeer();
        }
    ...
    public function getReport(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aReport === null && ($this->idreport !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aReport->addReportStatuss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ReportStatusPeer::DEFAULT_STRING_FORMAT);
    }
