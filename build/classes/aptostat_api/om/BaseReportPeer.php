...
abstract class BaseReportPeer
{
    ...
    /** the column name for the ErrorMessage field */
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ReportPeer::IDREPORT);
    ...
    /**
     * Selects a collection of Report objects pre-filled with their Service objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Report objects.
    ...
    public static function doSelectJoinService(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Report) to $obj2 (Service)
                $obj2->addReport($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ReportPeer::IDREPORT) && $criteria->keyContainsValue(ReportPeer::IDREPORT) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ReportPeer::IDREPORT);
            $value = $criteria->remove(ReportPeer::IDREPORT);
            if ($value) {
                $selectCriteria->add(ReportPeer::IDREPORT, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ReportPeer::IDREPORT, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(IncidentReportPeer::IDREPORT, $obj->getIdreport());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ReportPeer::DATABASE_NAME);
        $criteria->add(ReportPeer::IDREPORT, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ReportPeer::DATABASE_NAME);
            $criteria->add(ReportPeer::IDREPORT, $pks, Criteria::IN);
